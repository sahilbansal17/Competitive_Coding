...
A = point(int(input("Ax = ")), int(input("Ay = ")))
B = point(int(input("Bx = ")), int(input("By = ")))
C = point(int(input("Cx = ")), int(input("Cy = ")))


det = (B.x - A.x)*(C.y - A.y) - (C.x - A.x)*(B.y - A.y)

if det > 0: print("orientation: clockwise")
elif det < 0: print("orientation: counterclockwise")
else: print("collinear")
