...
int main(){
    node *head = NULL;
    int n, data_value, choice, search_value, node_value;
    ...
    for(int i = 0; i<n; i++){
        ...
        cout<<"Do you want node to be inserted at:"<<endl<<"1.Beginning(0)"<<endl<<"2.End(1)"
             <<endl<<"3.After a given node(3)"<<endl<<" 4.Before a particualr node(4)"
        ...
        switch(choice){
            ...
            case 3:
            case 4:
               cout<<"Enter the value of the node after/before which you want to insert new node : ";
               cin>>node_value;
               given_node = search(&head,node_value);
    ...
    displayData(&head);
    cout<<endl<<"Enter the value to be searched for:";
    cin>>search_value;
    node *result_node = searchNode(&head, search_value);
    cout<<endl<<result_node;
